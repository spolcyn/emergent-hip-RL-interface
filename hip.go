...
type Sim struct {
	...
	Dataset       *etable.Table // the dataset being considered
}
...
func (ss *Sim) MemStats(train bool) {
	...
	// SP: Test
	errorResult := ss.CalculateError(ecin, ecout)
...
func (ss *Sim) OpenPats() {
	...
	table := LoadDataset("data_generation/data.csv")
	ss.TrainAB = table
	ss.Dataset = ss.TrainAB
}
...
func (ss *Sim) ConfigGui() *gi.Window {
	...
	win := gi.NewMainWindow("hip", "Hippocampus Method of Loci Model", width, height)
	ss.Win = win
